-- Recriar a função corrigindo o erro de owner_user_id e gerando ref_code para comissões
...
BEGIN
  ...
  -- Criar tenant para o customer (SEM owner_user_id que não existe)
  INSERT INTO public.tenants (
    ...
    v_tenant_name,
    p_tenant_id,
    p_tenant_id,  -- O dono é o tenant do link usado para cadastro
    v_tenant_type,
    v_tenant_status,
  ...
  -- Criar customer vinculado ao tenant pai (dono do link)
  ...
  -- Gerar ref_code único para o cliente (para comissões de indicação)
  ...
  -- Criar ref_code para o cliente poder indicar outros
  ...
  -- Criar referral_link para rastrear comissões
