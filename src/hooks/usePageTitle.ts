...
const pageTitles: Record<string, { title: string; description: string }> = {
  ...
  '/app/auto_responder': { title: 'Auto-Responder IA | BRGestor', description: 'Configuração do auto-responder com IA no WhatsApp' },
  ...
  '/portal/meus_servicos': { title: 'Meus Serviços | Portal BRGestor', description: 'Seus serviços ativos' },
